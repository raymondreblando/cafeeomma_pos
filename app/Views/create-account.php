        ...
        <div class="w-[min(30rem,100%)] bg-white rounded-2xl p-6">
          <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-6">
            ...
            <div class="md:text-right">
              <p class="text-xs font-semibold text-black leading-none">Create Account</p>
              <p class="text-[10px] font-semibold text-black/60">Efficiently manage your cafe team</p>
            </div>
          </div>
          <form autocomplete="off" id="create-account-form">
            <div class="grid md:grid-cols-2 gap-4">
              ...
              <div>
                <div class="flex items-center h-10 bg-light-gray rounded-full px-6 mb-3">
                  <input type="text" name="employee_name" class="w-full h-full text-[10px] font-medium text-black placeholder:text-black/60 bg-transparent" placeholder="Enter employee name">
                </div>
                <div class="flex items-center h-10 bg-light-gray rounded-full px-6 mb-3">
                  <input type="text" name="username" class="w-full h-full text-[10px] font-medium text-black placeholder:text-black/60 bg-transparent" placeholder="Enter employee username">
                </div>
                ...
                <div class="flex items-center h-10 bg-light-gray rounded-full px-6 mb-3">
                  <input type="text" name="contact_number" class="w-full h-full text-[10px] font-medium text-black placeholder:text-black/60 bg-transparent" placeholder="Enter contact number" maxlength="11">
                </div>
              </div>
            </div>
            <div class="flex items-center h-10 bg-light-gray rounded-full px-6 mb-3">
              <input type="text" name="address" class="w-full h-full text-[10px] font-medium text-black placeholder:text-black/60 bg-transparent" placeholder="Enter address">
            </div>
            <button type="submit" id="create-account-btn" class="w-full md:w-fit h-10 bg-primary text-white text-[10px] font-medium px-8 rounded-full disabled:cursor-wait">Create Account</button>
          </form>
        </div>
      </div>
    </section>
